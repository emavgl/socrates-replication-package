...
contract Token is IToken, Owned, Utils {
    ...
    // INSTRUMENTED
    uint256 public expected_allowance = 0;
    uint256 public actual_allowance = 0;
        ...
        returns (bool)
    {
        ...
        expected_allowance = allowance[_from][msg.sender] - _value;

        allowance[_from][msg.sender] -= safeSub(allowance[_from][msg.sender], _value);
        actual_allowance = allowance[_from][msg.sender];
...
contract MKC is IMKC, Token {
    ...
    function echidna_invariant_I7() public returns (bool) {
        return expected_allowance == actual_allowance;
    }
}