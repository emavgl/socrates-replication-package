...
contract JAAGCoin is IERC20, Ownable {
    ...
    // INSTRUMENTED
    bool public successful_transferFrom_without_allowance = false;
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        ...
        if (_value > allowed[_from][msg.sender]) {
            successful_transferFrom_without_allowance = true;
        }
    ...
    function echidna_invariant_I6() public returns (bool) {
        return successful_transferFrom_without_allowance == false;
    }
}