...
contract DNCEQUITY is ERC223BasicToken{
  ...
  // INSTRUMENTED
  uint256 public mul1_1;
  uint256 public mul1_2;
  uint256 public mul1_result;


  // INSTRUMENTED
  uint256 public mul2_1;
  uint256 public mul2_2;
  uint256 public mul2_result;

	function mintNewDNC(address user, uint256 quantity) onlyadmin {
      mul1_1 = quantity;
      mul1_2 = (10**(decimals-1));
      mul1_result = quantity * (10**(decimals-1));
	...
	function burnDNC(address user, uint256 quantity) onlyadmin {
      mul2_1 = quantity;
      mul2_2 = (10**(decimals-1));
      mul2_result = quantity * (10**(decimals-1));
	    uint256 correctedQuantity = quantity * (10**(decimals-1));
        if(mintable[user] == true) {
    ...
    function echidna_invariant_I1() public returns (bool) {
        bool op1 = (mul1_1 == 0 || mul1_result / mul1_1 == mul1_2);
        bool op2 = (mul2_1 == 0 || mul2_result / mul2_1 == mul2_2);
        return (op1 && op2);
    } 
