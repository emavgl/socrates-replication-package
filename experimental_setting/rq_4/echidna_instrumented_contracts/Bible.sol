...
contract Bible is ERC20, SafeMath {
    ...
    // INSTRUMENTED
    bool public approval_is_always_emitted = true;

    function approve(address _spender, uint256 _value) isRunning validAddress public returns (bool success) {
        require(_value == 0 || allowance[msg.sender][_spender] == 0);
        allowance[msg.sender][_spender] = _value;
        approval_is_always_emitted = false;
        return true;
    }

    function echidna_invariant_I9() public returns (bool) {
        return approval_is_always_emitted == true;
    }
