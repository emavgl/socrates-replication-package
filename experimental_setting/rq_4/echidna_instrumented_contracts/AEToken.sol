...
contract StandardToken is Token {
    ...
    // INSTRUMENTED
    uint256 public add1_1;
    uint256 public add1_2;
    uint256 public add1_result;

    // INSTRUMENTED
    uint256 public add2_1;
    uint256 public add2_2;
    uint256 public add2_result;
    ...
    function transfer(address _to, uint256 _value) returns (bool success) {
        ...
        //if (balances[msg.sender] >= _value && balances[_to] + _value > balances[_to]) {
                ...
                add1_1 = balances[_to];         // instrumented
                add1_2 = _value;               //instrumented
				balances[_to] += _value;
                add1_result = balances[_to]; //instrumented
    ...
    function transferFrom(address _from, address _to, uint256 _value) returns (bool success) {
        ...
        //if (balances[_from] >= _value && allowed[_from][msg.sender] >= _value && balances[_to] + _value > balances[_to]) {
                ...
                add2_1 = balances[_to]; // instrumented
                add2_2 = _value;        // instrumented
				balances[_to] += _value; // existing
                add2_result = balances[_to];    // instrumented
